...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        replace: {
            ...
            messagerSize1: {
                src: ['../Source/Jinyinmao.Coupon/Jinyinmao.Coupon.MessageRole.CloudService/ServiceDefinition.csdef'],
                overwrite: true,
                replacements: [
                    {
                        from: '<WebRole name="Jinyinmao.Coupon.MessageRole" vmsize="ExtraSmall">',
                        to: '<WebRole name="Jinyinmao.Coupon.MessageRole" vmsize="ExtraSmall">'
                    }
                ]
            },
            messagerSize2: {
                ...
                replacements: [
                    {
                        from: '<WebRole name="Jinyinmao.Coupon.MessageRole" vmsize="ExtraSmall">',
                        to: '<WebRole name="Jinyinmao.Coupon.MessageRole" vmsize="Small">'
                    }
                ]
            }
        }
    ...
    grunt.registerTask('upgradeCloudServiceSize1', ['replace:messagerSize1']);
    grunt.registerTask('upgradeCloudServiceSize2', ['replace:messagerSize2']);
