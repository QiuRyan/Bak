/*!
 * jym Gruntfile
 * https://jym-product-daemon.chinacloudapp.cn
 */
...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        replace: {
            ...
            apiSize: {
                src: ['../Source/Jinyinmao.Daemon.CloudService/ServiceDefinition.csdef'],
                overwrite: true,
                replacements: [
                    {
                        from: '<WebRole name="Jinyinmao.Daemon" vmsize="Small">',
                        to: '<WebRole name="Jinyinmao.Daemon" vmsize="Medium">'
                    }
                ]
            }
        }
