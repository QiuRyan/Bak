...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        replace: {
            ...
            varicodeapiSize: {
                src: ['../Source/Jinyinmao.ValidateCode.Api.CloudService/ServiceDefinition.csdef'],
                overwrite: true,
                replacements: [
                    {
                        from: '<WebRole name="Jinyinmao.ValidateCode.Api" vmsize="Small">',
                        to: '<WebRole name="Jinyinmao.ValidateCode.Api" vmsize="Large">'
                    }
                ]
            },
            messsageapiSize: {
                src: ['../Source/Jinyinmao.MessageManager.CloudService/ServiceDefinition.csdef'],
                overwrite: true,
                replacements: [
                    {
                        from: '<WebRole name="Jinyinmao.MessageManager.Api" vmsize="Small">',
                        to: '<WebRole name="Jinyinmao.MessageManager.Api" vmsize="Large">'
                    }
                ]
             },
             messageWokerSize: {
                src: ['../Source/jinyinmao.MessageWorker.CloudService/ServiceDefinition.csdef'],
                overwrite: true,
                replacements: [
                    {
                        from: '<WorkerRole name="Jinyinmao.MessageWoker" vmsize="Small">',
                        to: '<WorkerRole name="Jinyinmao.MessageWoker" vmsize="Large">'
                    }
                ]
            }
        }
    ...
    grunt.registerTask('upgradeCloudServiceSize', ['replace:varicodeapiSize', 'replace:messsageapiSize', 'replace:messageWokerSize']);
