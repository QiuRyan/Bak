...
// Last Modified On : 2015-12-06  18:49
// ***********************************************************************
...
using Jinyinmao.MessageManager.Api;
        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "Jinyinmao.MessageManager.Api");
                    ...
                    //
                    c.IncludeXmlComments(Path.Combine(HttpRuntime.AppDomainAppPath, "bin", "Jinyinmao.MessageManager.Api.XML"));
                    //c.IncludeXmlComments(Path.Combine(HttpRuntime.AppDomainAppPath, "bin", "Jinyinmao.Application.ViewModel.xml"));
