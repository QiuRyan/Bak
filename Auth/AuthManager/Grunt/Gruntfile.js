...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        replace: {
            ...
            apiSize: {
                src: ['../Source/Api/Jinyinmao.AuthManager.Api.CloudService/ServiceDefinition.csdef'],
                overwrite: true,
                replacements: [
                    {
                        from: '<WebRole name="Jinyinmao.AuthManager.Api" vmsize="ExtraSmall">',
                        to: '<WebRole name="Jinyinmao.AuthManager.Api" vmsize="Small">'
                    }
                ]
            },
            siloSize: {
                src: ['../Source/Api/Jinyinmao.AuthManager.Silo.CloudService/ServiceDefinition.csdef'],
                overwrite: true,
                replacements: [
                    {
                        from: '<WorkerRole name="Jinyinmao.AuthManager.Silo" vmsize="Small">',
                        to: '<WorkerRole name="Jinyinmao.AuthManager.Silo" vmsize="Medium">'
                    }
                ]
            }
        }
    ...
    grunt.registerTask('upgradeCloudServiceSize', ['replace:apiSize', 'replace:siloSize']);
